namespace UIWidgets
{
	...
	public class NotificationButton : ButtonConfiguration<NotificationBase>
	{
		...
		public NotificationButton(string label, int templateIndex = 0)
		...
		/// <summary>
		/// Convert string to the NotificationButton.
		/// </summary>
		/// <param name="label">Label.</param>
		public static implicit operator NotificationButton(string label)
		{
			return new NotificationButton(label);
		}
	}
}